...
$ pyats run job DevNet_Sandbox_Nexus9k_iago_job.py --testbed-file testbed/testbed_DevNet_Nexus9k_Sandbox.yaml
...
def main(runtime):
    ...
    testscript = os.path.join(os.path.dirname(__file__), 'DevNet_Sandbox_Nexus9k_iago.py')
