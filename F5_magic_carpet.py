        ...
        for device in testbed['devices']:
            ...
            with steps.start('Store data',continue_=True) as step:
                ...
                if hasattr(self, 'raw_vs'):
                    ...
                    with open("Cave_of_Wonders/F5/Virtual_Servers/%s_virtual_servers.json" % device_alias, "w") as fid:
                        json.dump(self.vs_json, fid, indent=4, sort_keys=True)

                    with open("Cave_of_Wonders/F5/Virtual_Servers/%s_virtual_servers.yaml" % device_alias, "w") as yml:
                    ...
                    for filetype in filetype_loop:
                        ...
                        with open("Cave_of_Wonders/F5/Virtual_Servers/%s_virtual_servers.%s" % (device_alias,filetype), "w") as fh:
                            fh.write(parsed_output_vs) 
                    
                        os.system("markmap Cave_of_Wonders/F5/Virtual_Servers/%s_virtual_servers.md --output Cave_of_Wonders/F5/Virtual_Servers/%s_virtual_servers_mind_map.html" % (device_alias,device_alias))
                ...
                if hasattr(self, 'raw_ssl_cert'):
                    ...
                    with open("Cave_of_Wonders/F5/SSL_Certificates/%s_ssl_certificates.json" % device_alias, "w") as fid:
                        json.dump(self.ssl_cert_json, fid, indent=4, sort_keys=True)

                    with open("Cave_of_Wonders/F5/SSL_Certificates/%s_ssl_certificates.yaml" % device_alias, "w") as yml:
                    ...
                    for filetype in filetype_loop:
                        ...
                        with open("Cave_of_Wonders/F5/SSL_Certificates/%s_ssl_certificates.%s" % (device_alias,filetype), "w") as fh:
                            fh.write(parsed_output_ssl_cert) 
                    
                        os.system("markmap Cave_of_Wonders/F5/SSL_Certificates/%s_ssl_certificates.md --output Cave_of_Wonders/F5/SSL_Certificates/%s_ssl_certificates_mind_map.html" % (device_alias,device_alias))
