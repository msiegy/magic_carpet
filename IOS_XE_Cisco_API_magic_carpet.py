            ...
            with steps.start('Store data',continue_=True) as step:
                ...
                if hasattr(self, 'parsed_show_version'):
                    ...
                    for version,value in self.parsed_show_version.items():
                        ...
                        with open("Cave_of_Wonders/Cisco/APIs/Recommended_Release/%s_recommended_release.json" % device.alias, "w") as fid:
                          json.dump(recommended_release_json, fid, indent=4, sort_keys=True)

                        with open("Cave_of_Wonders/Cisco/APIs/Recommended_Release/%s_recommended_release.yaml" % device.alias, "w") as yml:
                        ...
                        for filetype in filetype_loop:
                            ...
                            with open("Cave_of_Wonders/Cisco/APIs/Recommended_Release/%s_recommended_release.%s" % (device.alias,filetype), "w") as fh:
                ...
                if hasattr(self, 'parsed_show_inventory'):
                    ...
                    if os.path.exists("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.json.json" % (device.alias)):
                       os.remove("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.json.json" % (device.alias))

                    if os.path.exists("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.yaml" % (device.alias)):
                       os.remove("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.yaml" % (device.alias))

                    for filetype in filetype_loop:
                        if os.path.exists("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.%s" % (device.alias,filetype)):
                            os.remove("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.%s" % (device.alias,filetype))

                    with open("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.csv" % device.alias,'a') as csv:
                        csv.seek(0, 0)
                    ...
                    with open("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.md" % device.alias,'a') as md:
                        md.seek(0, 0)
                    ...
                    with open("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.html" % device.alias,'a') as html:
                        html.seek(0, 0)
                                ...
                                for sn,value in value.items():
                                    ...
                                    with steps.start('Calling API',continue_=True) as step:
                                        try:                                      
                                            ...
                                            with open("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.yaml" % device.alias, "a") as yml:
                                            ...
                                            for filetype in filetype_loop:
                                                ...
                                                with open("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.%s" % (device.alias,filetype), "a") as fh:
                                                    fh.write(parsed_output_type)
                    ...
                    if os.path.exists("Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.md" % device.alias):
                        os.system("markmap --no-open Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info.md --output Cave_of_Wonders/Cisco/APIs/Serial_2_Info/%s_serial_2_info_mind_map.html" % (device.alias,device.alias))
                    print("Our Monkey Friend is Back from the Cloud")
