...
if os.path.exists("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols.yaml"):
    os.remove("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols.yaml")

for filetype in filetype_loop:
    if os.path.exists("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols.%s" % filetype):
        os.remove("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols.%s" % filetype)

if os.path.exists("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.json"):
    os.remove("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.json")

if os.path.exists("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.yaml"):
    os.remove("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.yaml")

for filetype in filetype_loop:
    if os.path.exists("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.%s" % filetype):
        os.remove("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.%s" % filetype)
...
class Collect_Information(aetest.Testcase):
    ...
    def parse(self, section, steps):
        ...
        for device in testbed['devices']:
            ...
            # Define Templates 
            allowed_protocols_template = env.get_template('allowed_protocols.j2')
            allowed_protocol_details_template = env.get_template('allowed_protocol_details.j2')

            with open("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.csv",'a') as csv:
                csv.seek(0, 0)
                csv.write("Name,Description,Host Lookup,Require Message Auth,Allow CHAP,Allow EAP FAST,Allow EAP MD5,Allow EAP TLS,Allow EAP TTLS,Allow LEAP,Allow MSCHAPv1,Allow MSCHAv2,Allow PAP ASCII,Allow PEAP,Allow Preferred EAP,Allow Weak Ciphers for EAP,EAP TTLS Bit")
                csv.close()  
            with open("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.md",'a') as md:
                md.seek(0, 0)
                md.write("# Allowed Protocol Details")
                md.write("\n")
                md.write("| Name | Description | Host Lookup | Require Message Auth | Allow CHAP | Allow EAP FAST | Allow EAP MD5 | Allow EAP TLS | Allow EAP TTLS | Allow LEAP | Allow MSCHAPv1 | Allow MSCHAv2 | Allow PAP ASCII | Allow PEAP | Allow Preferred EAP | Allow Weak Ciphers for EAP | EAP TTLS Bit |")
                md.write("\n")
                md.write("| ---- | ----------- | ----------- | -------------------- | ---------- | -------------- | ------------- | ------------- | -------------- | ---------- | -------------- | ------------- | --------------- | ---------- | ------------------- | -------------------------- | ------------ |")
                md.close()
            with open("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.html",'a') as html:
                html.seek(0, 0)
                html.write("<html><body><h1>Allowed Protocol Details</h1><table style=\"width:100%\">")
                html.write("\n")
                html.write("<tr><th>Name</th><th>Description</th><th>Host Lookup</th><th>Require Message Auth</th><th>Allow CHAP</th><th>Allow EAP FAST</th><th>Allow EAP MD5</th><th>Allow EAP TLS</th><th>Allow EAP TTLS</th><th>Allow LEAP</th><th>Allow MSCHAPv1</th><th>Allow MSCHAv2</th><th>Allow PAP ASCII</th><th>Allow PEAP</th><th>Allow Preferred EAP</th><th>Allow Weak Ciphers for EAP</th><th>EAP TTLS Bit</th></tr>")
                html.close() 
            ...
            with steps.start('Store data',continue_=True) as step:
                print(Panel.fit(Text.from_markup(WRITING, justify="center")))       
                with open("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols.json", "a") as fid:
                    json.dump(self.raw_allowed_protocols.json(), fid, indent=4, sort_keys=True)
                    fid.write('\n')
                            
                with open("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols.yaml", "a") as yml:
                ...
                for filetype in filetype_loop:
                    ...
                    with open("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols.%s" % filetype, "a") as fh:
            ...
            if os.path.exists("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols.md"):
                os.system("markmap --no-open Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols.md --output Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocols_mind_map.html")
            ...
            for device in self.raw_allowed_protocols.json()['SearchResult']['resources']:
                ...
                with steps.start('Store data',continue_=True) as step:
                    ...
                    with open("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.json", "a") as fid:
                        json.dump(self.raw_allowed_protocol_details.json(), fid, indent=4, sort_keys=True)
                        fid.write('\n')
                            
                    with open("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.yaml", "a") as yml:
                    ...
                    for filetype in filetype_loop:
                        ...
                        with open("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.%s" % filetype, "a") as fh:
            ...
            if os.path.exists("Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.md"):
                os.system("markmap --no-open Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details.md --output Cave_of_Wonders/Cisco/ISE/Allowed_Protocols/allowed_protocol_details_mind_map.html")
            ...
            if os.path.exists("Cave_of_Wonders/Cisco/ISE/Active_Sessions/active_session_totals.md"):
                os.system("markmap --no-open Cave_of_Wonders/Cisco/ISE/Active_Sessions/active_session_totals.md --output Cave_of_Wonders/Cisco/ISE/Active_Sessions/active_session_totals_mind_map.html")
            ...
            if os.path.exists("Cave_of_Wonders/Cisco/ISE/Active_Sessions/active_session_totals.md"):
                os.system("markmap --no-open Cave_of_Wonders/Cisco/ISE/Active_Sessions/active_session_details.md --output Cave_of_Wonders/Cisco/ISE/Active_Sessions/active_session_details_totals_mind_map.html")
